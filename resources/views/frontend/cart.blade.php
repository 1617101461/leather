				...
				<div class="row row-pb-md">
					<div class="col-md-10 col-md-offset-1">
						...
						<div class="product-cart">
							<div class="one-forth">
								<div class="product-img" style="background-image: url(assets/frontend/images/item-6.jpg);">
								</div>
						...
						<div class="product-cart">
							<div class="one-forth">
								<div class="product-img" style="background-image: url(assets/frontend/images/item-7.jpg);">
								</div>
								<div class="display-tc">
									<h3>Product Name</h3>
								</div>
						...
						<div class="product-cart">
							<div class="one-forth">
								<div class="product-img" style="background-image: url(assets/frontend/images/item-8.jpg);">
								</div>
								<div class="display-tc">
									<h3>Product Name</h3>
								</div>
