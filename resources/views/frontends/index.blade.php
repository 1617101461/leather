...
<body>
    ...
    <section class="slider_area row m0">
        <div class="slider_inner">
            <div data-thumb="{{ asset ('assets/frontend/images/as_leather_accessories-20180905-0025.jpg') }}" data-src="{{ asset ('assets/frontend/images/as_leather_accessories-20180905-0004.jpg') }}">
                <div class="camera_caption">
                   <div class="container">
                        <h5 class=" wow fadeInUp animated">Selamat Datang Di</h5>
                        <h3 class=" wow fadeInUp animated" data-wow-delay="0.5s">AS LEATHER</h3>
                   </div>
                </div>
            </div>
            <div data-thumb="{{ asset ('assets/frontend/images/as_leather_accessories-20180905-0014.jpg') }}" data-src="{{ asset ('assets/frontend/images/as_leather_accessories-20180905-0006.jpg') }}">
                <div class="camera_caption">
                   <div class="container">
                        <h5 class=" wow fadeInUp animated">Selamat Datang Di</h5>
                        <h3 class=" wow fadeInUp animated" data-wow-delay="0.5s">AS LEATHER</h3>
                   ...
                   @foreach($barangs as $data)
                    <div class="single_facilities col-xs-4 p0 painting{{$data->kategoris->id}}">
                       <div class="single_facilities_inner">
                          	<div class="about_image"><img src="{{ asset ('assets/img/barang/' .$data->gambar. '' ) }}" width="400" height="400"></div><br>
                ...
                <div class="item">
                    <div class="media">
                        <div class="media-left">
                            <a href="#">
                                <img class="media-object" src="{{ asset ('assets/img/testimoni/' .$data->gambar. '' ) }}" height="200" width="200" alt="">
                            </a>
                        </div>
                    </div>
                    <center>
                    ...
                    <p><i class="fa fa-quote-right" aria-hidden="true"></i>{!! $data->testimoni !!}<i class="fa fa-quote-left" aria-hidden="true"></i></p>
                </div>
                @endforeach
            </div>
        </div>
...
<input id="{{$no}}" type="checkbox" class="carouselFullScreen" />
   ...
   <!-- blog-2 area -->
@php
$artikels =App\artikels::take(3)->get();
@endphp
    ...
    <footer class="footer_area">
        ...
        <div class="copyright_area">
            Copyright 2018 All rights reserved. Designed by AS LEATHER.</a>
        </div>
    </footer>
